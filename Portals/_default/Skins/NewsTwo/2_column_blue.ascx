...
<dnn:STYLES runat="server" id="NewsTwoBlueStyle" Name="NewsTwoBlue" StyleSheet="themes/blue/blue.css" UseSkinPath="true" />
...
<div class="NewsTwoMain">
	...
	<div class="NewsTwoContent">
		<div class="EDS_panes-holder">
			<div class="EDS_two-column-content" runat="server" id="ContentPane"></div>
		...
		<div class="EDS_panes-holder-invert">
			...
			<div class="EDS_two-column-content" runat="server" id="ContentPaneRight"></div>
			<div class="clear"></div>
		</div>
