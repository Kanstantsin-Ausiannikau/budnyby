		...
		<div class="settings_category_container">
			...
			<table border="0" class="main_content grid_view_table" width="100%">
				...
				<tr>
					...
					<td class="rightwidth">
						<div>
							<asp:TextBox ID="tbInvoiceID" runat="server" Width="300px" MaxLength="100" ValidationGroup="vgInvoiceID"></asp:TextBox>
						</div>
						<div>
							<asp:RequiredFieldValidator ID="rfvInvoiceID" runat="server" ControlToValidate="tbInvoiceID" ErrorMessage="This field is required." ValidationGroup="vgInvoiceID" CssClass="msgareq"></asp:RequiredFieldValidator>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div>
							<asp:TextBox ID="tbOriginalInvoiceID" runat="server" Width="300px" MaxLength="100" ValidationGroup="vgInvoiceID" Visible="False"></asp:TextBox>
						</div>
						<div>
							<asp:RequiredFieldValidator ID="rfvOriginalInvoiceID" runat="server" ControlToValidate="tbOriginalInvoiceID" ErrorMessage="This field is required." ValidationGroup="vgInvoiceID" Enabled="False" Visible="False" CssClass="msgareq"></asp:RequiredFieldValidator>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<asp:Button ID="btnActivate" runat="server" OnClick="btnActivate_Click" Text="Activate" ValidationGroup="vgInvoiceID" />
					</td>
				</tr>
				<tr>
					<td>
