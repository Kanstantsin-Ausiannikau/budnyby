		...
		<div id="EDNadmin">
			...
			<asp:Panel ID="pnlContentLocalizationDetails" CssClass="main_content" runat="server" Visible="false">
				...
				<asp:Panel ID="pnlMainImageLocalization" runat="server">
					<div class="text_input_set">
						<dnn:Label ID="lblMainImageTitleLozalization" runat="server" CssClass="text s18" HelpKey="Main image title localization." HelpText="Article" ResourceKey="lblMainImageTitleLozalization" Text="Main image title:" />
				...
				<asp:Panel ID="pnlCustomFieldsLocalization" runat="server" Style="margin-top: 30px;" class="collapsible_box">
					<div class="text_input_set">
										...
										<asp:Panel ID="pnlArticleImageUpload" runat="server">
											...
											<div class="add_video_by_url">
												<p>
													...
													<asp:TextBox runat="server" ID="tbEmbedVideoURL" ValidationGroup="vgAddEmbedVideo" onblur="if(this.value=='') {this.value=this.defaultValue;}" onfocus="if(this.defaultValue==this.value) {this.value = '';}" value="Enter video URL..." />
														...
														<table cellpadding="0" cellspacing="0" width="100%">
															<tr>
																...
																<td class="edit_fields">
																	<asp:TextBox ID="TextBox3" runat="server" resourcekey="TextBox3Resource1" Text='<%# Bind("Title") %>' />
																</td>
																<td class="edit_fields">
																	<asp:TextBox ID="TextBox2" runat="server" resourcekey="TextBox2Resource1" Text='<%# Bind("Description") %>' TextMode="MultiLine" />
																</td>
															</tr>
														</table>
													</EditItemTemplate>
														...
														<table cellpadding="0" cellspacing="0" width="100%">
																...
																<td class="position_show_type">
																	<div class="action_box">
																		<div class="action_wrapper">
																			<asp:ImageButton ID="imbMediaUp" runat="server" CausesValidation="false" CommandArgument='<%# Eval("PictureID") %>' CommandName="Up" CssClass="position_btn up" ImageUrl="~/images/action_up.gif" resourcekey="imbMediaUpResource1" />
																			<asp:ImageButton ID="imbMediaDown" runat="server" CausesValidation="false" CommandArgument='<%# Eval("PictureID") %>' CommandName="Down" CssClass="position_btn down" ImageUrl="~/images/action_down.gif" resourcekey="imbMediaDownResource1" />
																		</div>
																		<span class="text">
																			<%=Position%></span>
																	</div>
															...
															<tr>
																<td class="token_wrapper" colspan="5">
																	<asp:TextBox ID="lblGalleryInsertArtGallery" runat="server" CssClass="token_box" resourcekey="lblGalleryInsertArtGalleryResource1" ReadOnly="True" Text='<%# GenerateTokens(Eval("PictureID")) %>' />
										...
										<Columns>
											<asp:TemplateField HeaderText="Actions">
												...
												<ItemTemplate>
													...
													<asp:LinkButton ID="lbDeleteLink" CssClass="action_btn red_x" runat="server" CausesValidation="false" CommandName="Delete" ToolTip="Delete this link" CommandArgument='<%#Eval("LinkID")%>' />
												</ItemTemplate>
												<HeaderStyle CssClass="actions" />
												<ItemStyle CssClass="actions" />
											</asp:TemplateField>
