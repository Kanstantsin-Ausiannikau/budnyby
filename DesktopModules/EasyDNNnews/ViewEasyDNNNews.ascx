...
<div id="<%=MainDivID%>" class="<%=MainDivClass%>">
	...
	<asp:Panel ID="pnlListArticles" runat="server">
		<asp:Literal ID="litSearchInfo" runat="server" Visible="false" EnableViewState="false" />
		<%=DisplayBeforeMulti()%>
	...
	<asp:Panel ID="pnlViewArticle" runat="server">
		...
		<asp:LinkButton ID="lbPublishArticle" CssClass="admin_action publish_article" OnClick="lbPublishArticle_Click" Visible="false" runat="server" Text="Published" />
		<asp:LinkButton ID="lbApproveArticle" CssClass="admin_action publish_article" OnClick="lbApproveArticle_Click" Visible="false" runat="server" Text="Approve" />
